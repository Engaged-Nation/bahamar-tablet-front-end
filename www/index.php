<?php require_once __DIR__ . '/../../bahamar-tablet-portal/vendor/engaged-nation/portal-core/FrontEnd/Bootstrap/client-front-end.php'; ?>
<!DOCTYPE html>
<html lang="en" class="setTo100">
<head>
    <title>$290,000 Truckload of Winning by Tachi Palace Casino</title>
    <?php require_once __DIR__ . '/../../bahamar-tablet-portal/vendor/engaged-nation/portal-core/GoogleTagManager/Resources/public/gtm.php'; ?>
...
<body>
    ...
    <script src="//<?php echo $enConfigClient['environment']['site_portal']; ?>/lib/js/engage.php?client_name=bahamar-tablet&client_id=192d776e209e8b979e967f26a10f423c" type="text/javascript"></script>
